...
def make_loaders(root="data", img_size=224, bs=32, num_workers=0):  # <- set to 0
    ...
    print(f"Found {len(train_ds)} train images and {len(val_ds)} val images.", flush=True)
    print("Classes:", train_ds.classes, flush=True)
